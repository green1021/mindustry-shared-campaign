...
public final class NetworkLauncher {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.setSecurityManager(new SecurityManager(){
            ...
            @Override public void checkListen(int p){if(p<41000||p>41999) throw new SecurityException("Port denied");}
            @Override public void checkConnect(String h,int p){if(!h.equals("127.0.0.1") || (p!=-1 && (p<41000||p>41999))) throw new SecurityException("Endpoint denied");}
            @Override public void checkAccept(String h,int p){if(!h.equals("127.0.0.1")) throw new SecurityException("Accept denied");}
        ...
        System.out.println("SC_NETWORK_LOOPBACK_GUARD");
